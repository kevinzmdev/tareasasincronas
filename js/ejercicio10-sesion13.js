...
alert(`Se vendio  ${entradaMayor} entradas general, recaudando ${entradamayor*65} soles`);
alert(`Se vendio  ${entradaMenor} entradas general, recaudando ${entradaMenor*80} soles`);
